...
# static proposal variance for theta
function bernoulli_mcmc(theta::AbstractArray, propvar::AbstractArray, data::InputData, m::Int64, thetapriors::NamedTuple, betapriors::NamedTuple, outdir::String, nsamps::Int64; adaptstart = 50, pgwarmup = 100)
